...
$(function () { //////////// jQB //////////////////////
    ...
    */
    ...
    $("input[type=text][id!=email2][id!=id], input[type=password][id!=pw]")
        .blur(function () {
        ...
        /*
        var racheck = $('.nation_wrap .input_radio:checked').length;  
        console.log(racheck);
        */
    ...
    $("#btnj").click(function (e) { // e- 이벤트 전달변수
        ...
        // -> trigger("blur")
        $("input[type=text][id!=email2][id!=id], input[type=password][id!=pw]").trigger("blur");
...
$(function(){ //////////// jQB //////////////////////
    ...
    //var memClick = $("#memForm").
    
    $(".memClick").click(function(){
        $(this).css({borderColor:"#333"}).parent().siblings().find(".memClick").css({borderColor:"#e0e0e0"});
    }); 
